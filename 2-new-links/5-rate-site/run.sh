...
JOB_PATH="$ROOT_PATH/script/2-new-links/5-rate-site"
INPUT_PATH="$ROOT_PATH/script/2-new-links/4-rate-url/NewLinksRateUrl"
OUTPUT_PATH="$JOB_PATH/NewLinksRateSite"
